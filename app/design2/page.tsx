    ...
    <div className="bg-base-secondary">
      ...
      <style>{`
        :root {
          ...
          --bg-nav:            #F0F0F0;  /* navbar / footer — SOLID version of the card glass tint (rgba 36,36,38 @7% pre-blended over white) */
        ...
        img[alt*="Sydney logo"] {
          content: url("/web images/sydney rubbish removal near me logo.png");
        }
        ...
        /* Same visible diagonal as the cards on the FOOTER (single element). */
        footer.bg-nav {
          box-shadow: inset 8px 8px 20px rgba(255, 255, 255, 0.85),
                      inset -10px -10px 24px rgba(0, 0, 0, 0.10);
        }
